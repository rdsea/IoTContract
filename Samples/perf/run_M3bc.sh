...
sshpass -p 'raspi1234' ssh -R 8088:localhost:8088 pi@c1n2 "cd /home/pi/pklein/Samples/scenario_1_DPNameCheck; ../perf/runSensor.sh 'Sensor1160629000_114_1000ev.json' 'topology.json' 'Sensor1160629000_114' > ../perf/m3bc.out" &